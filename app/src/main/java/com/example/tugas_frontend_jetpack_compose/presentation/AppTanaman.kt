...
import com.example.tugas_frontend_jetpack_compose.navigation.NavigationItem
...
fun AppTanaman(
    ...
    Scaffold(
        topBar = {
            TopAppBar(
                title = { Text(text = "App Tanaman") },
                actions = {
                    IconButton(onClick = { /* Tambahkan aksi Anda di sini */ }) {
                        Icon(
